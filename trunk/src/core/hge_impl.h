...
public:
	...
	//Tu.NguyenHoang 
	virtual bool		CALL	ProcessInput(SDL_Event* event);
	virtual int			CALL	SDLKeyToHgeKey(int key);
	...
	virtual DWORD		GetScreenWidth() ;
	virtual DWORD		GetScreenHeight();
	virtual DWORD		GetScreenDeapth();
