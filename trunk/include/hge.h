...
public:
	...
	virtual DWORD		CALL GetScreenWidth() = 0;
	virtual DWORD		CALL GetScreenHeight() = 0;
	virtual DWORD		CALL GetScreenDeapth() = 0;
};

extern HGE* CALL hgeCreate(int ver);
//typedef struct tagPOINT
//{
//	LONG  x;
//	LONG  y;
...
//Tu.NguyenHoang
#if defined(WIN32)
#define DEBUG_OUT(...){printf(__VA_ARGS__); printf("\n");}
#elif defined(ANDROID)
#include <android/log.h>
#define DEBUG_OUT(...)		    __android_log_print(ANDROID_LOG_DEBUG, "TANK - INFO", __VA_ARGS__) 
#endif
//Tu.NguyenHoang
